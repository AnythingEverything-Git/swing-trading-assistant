...
scheduler_heartbeat host_catchup running "initial catch-up" "1d_watermark"
...
exec 9>&-
scheduler_heartbeat host_catchup running "initial catch-up" "1m_today"
...
exec 9>&-
scheduler_heartbeat host_catchup running "initial catch-up" "1m_watermark"
...
echo
scheduler_heartbeat host_catchup ok "initial catch-up finished" "done"
